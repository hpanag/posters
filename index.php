...
<title>Harjot.com - Posters</title>
...
<a class="responsive-menu-button" href="#"><img src="images/11.png"/></a>
            	...
            	<div class="menu" id="navigation">
            		<ul>
                        ...
                        <li><a href="#stories">Posters</a></li>
    ...
    <div class="banner">
    	<div class="container">
        	<div class="header-text">
           	  <p class="big-text">Feel free to download / print any or all posters FREE of charge.        	</p>
        	</div>
        </div>
    </div>
    ...
    <div class="desc">
    	<div class="container">
        	<h2><span class="text-head">Translators Needed</span></h2>
            <p><span class="box-desc">Looking for individuals who can translate these posters into other languages.</span></p>
        </div>
    </div>
